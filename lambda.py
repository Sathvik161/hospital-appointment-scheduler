...
class NewPatientIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        speak_output = "Thank you for choosing XYZ Hospital. Please provide your information. What is your full name?"
        return handler_input.response_builder.speak(speak_output).ask(speak_output).response
...
class GatherUserInfoIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        if email not in verified_emails:
            ...
            speak_output = f"Thank you for providing your information. Your ID is {patient_id}. The details have been sent to the email.How may I assist you today?"
...
class VerifyEmailIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        store_user_info(patient_id, patient_name, age, gender, DOB, Father_name, email)
        send_email(email, patient_name, patient_id)
        speak_output = f"Thank you for verifying your email. Your ID is {patient_id}.The details have been sent to your email."
    ...
    def handle(self, handler_input):
        ...
        if not patient_id:
            ...
            if 'Item' in response:
                ...
                email = patient['email']
                speak_output = f"Welcome back! {patient_name} How may I assist you today?"
        ...
        if not father_name:
            ...
            if len(items) > 0:
                ...
                if 'Item' in response:
                    ...
                    speak_output = f"Welcome back! {patient_name}. Your Patient ID is {patient_id}. Please remember it for future assistance. How may I assist you today?"
                    handler_input.attributes_manager.session_attributes['patient_id'] = patient_id
            else:
    ...
    def handle(self, handler_input):
        ...
        if not specialization:
            ...
            if available_doctors:
                ...
                speak_output += "Please choose a doctor from the list to schedule an appointment."
            else:
